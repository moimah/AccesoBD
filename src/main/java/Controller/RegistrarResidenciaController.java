...
import Model.RegistrarResidenciasModel;
...
public class RegistrarResidenciaController implements Initializable {
	@FXML
	private VBox root;
	@FXML
	...
	//Others
	private RegistrarResidenciasModel model = new RegistrarResidenciasModel();
	...
	//Constructor
	public RegistrarResidenciaController() throws IOException {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/RegistrarResidenciaView.fxml"));
		...
		try {
			...
			if(mre.insertarResidencia(r)) {
				...
				model.setUniversidadSeleccionada("");					
					...
					alerta.setContentText("No se ha insertado la residencia");
					alerta.showAndWait();
					model.setTxtNombreResidencia("");
					model.setTxtPrecioMensual("");
					model.setUniversidadSeleccionada("");
